    ...
    return (
        <>
            <div className="mt-8 text-center">
                ...
                <button className=" bg-pink-600 text-white rounded-full px-6 py-3 m-6 hover:bg-white hover:text-pink-600 hover:border hover:border-pink-600"><Link to={'/menulist'}>Menu</Link></button>
            </div>
        </>
    )
}
